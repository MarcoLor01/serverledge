...
const FUNCTION_OFFLOADING_POLICY_NODE_TO_EDGE = "function.offloading.policy.bandwidth"

const FUNCTION_OFFLOADING_POLICY_LAMBDA_TO_CLOUD = "function.offloading.policy.lambda.bandwidth"
...
const FUNCTION_OFFLOADING_POLICY_PROFILING_MIN_EXEC_NUMBER = "function.offloading.policy.profiling.min.exec.number"

const FUNCTION_OFFLOADING_POLICY_PROFILING_TRIGGER = "function.offloading.policy.profiling.trigger"

const FUNCTION_OFFLOADING_CLOUD_BANDWIDTH = "function.offloading.cloud.bandwidth"

const OPTIMIZER_WAITING_INTERVAL = "optimizer.waiting.interval"

const PROFILING_INTERVAL = "profiling.interval"

const EDGE_NODES_ENABLED = "edge.nodes.enabled"

const CLOUD_NODES_ENABLED = "cloud.nodes.enabled"
